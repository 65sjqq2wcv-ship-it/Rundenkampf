...
class PDFExporter {
    ...
    async exportToPDF() {
        try {
            ...
            const htmlContent = this.createPDFHTML(filteredTeams, competitionType, cssStyles);
            ...
            <div class="header-content">
                ...
                <div class="title-container">
                    ...
                    <div class="subtitle-info">
                        <div class="info-row">
                            <strong>Disziplin:</strong> ${UIUtils.escapeHtml(storage.selectedDiscipline || 'Nicht gewählt')}
                        </div>
                        <div class="info-row">
                            <strong>Wettkampfdatum:</strong> ${new Date().toLocaleDateString('de-DE')}
                        </div>
                    </div>
                </div>
            </div>
    ...
    createTeamSection(team, competitionType) {
        ...
        if (competitionType === CompetitionType.ANNEX_SCHEIBE) {
            ...
            tableHtml = this.createStandardTable(shooterData, worstShooterId, teamTotal);
        }
        ...
        <section class="team-section">
            <h2 class="team-title">
                ...
                <span class="team-count">(${team.shooters.length} Schützen)</span>
            </h2>
            ${tableHtml}
        </section>
        `;
